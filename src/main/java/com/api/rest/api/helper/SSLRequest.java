...
public class SSLRequest {
	...
	public static void main(String[] args) {
		...
		RestResponse putresponse=HttpsClientHelper.performPutRequestWithSSL("https://localhost:8443/laptop-bag/webapi/sslres/update",f, ContentType.APPLICATION_JSON, headers);
		...
		System.out.println("\nThis is a delete request based on id : ");
		RestResponse deleteresponse = HttpsClientHelper.performDeleteRequestWithSSL("https://localhost:8443/laptop-bag/webapi/sslres/delete/"+id, header);
		...
		Assert.assertEquals(HttpStatus.SC_NOT_FOUND,getrequestidafterdelete.getStatusCode());
	}
}
