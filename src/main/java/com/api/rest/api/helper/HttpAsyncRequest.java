...
public class HttpAsyncRequest {
	...
	public static void main(String[] args) {		
		...
		RestResponse getresponse=HttpAsyncClientHelper.performGetRequestAsync("http://localhost:8087/laptop-bag/webapi/api/all", headers);
		...
		RestResponse getresponse1=HttpAsyncClientHelper.performGetRequestAsync("http://localhost:8087/laptop-bag/webapi/api/find/"+id, headers);
		System.out.println(getresponse1.toString());

		RestResponse deleteresponse=HttpAsyncClientHelper.performDeleteRequestAsync("http://localhost:8087/laptop-bag/webapi/api/delete/"+id, null);
		System.out.println(deleteresponse.toString());

		RestResponse getresponse2=HttpAsyncClientHelper.performGetRequestAsync("http://localhost:8087/laptop-bag/webapi/api/find/"+id, headers);
